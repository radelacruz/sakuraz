				...
				<table class="table table-striped table-bordered">
						...
						?>
							 	<tr class="text-center">
							 		...
							 		<td class="item_quantity">
							 			<input type="number" value="<?php echo $qty; ?>" class="form-control" data-id="<?php echo $id; ?>" min="1" max="100">
							 		</td>
					...
					<tfoot>
						<tr>
							...
							<td class="text-center font-weight-bold" id="total_price"><?php echo $cart_total; ?></td>
